...
parameters_file_cart_tlr = "experiments/cartpole_low_rank_tlr_learner.json"
...
parameters_file_mountaincar_tlr = "experiments/mountaincar_low_rank_tlr_learner.json"
...
with open(parameters_file_cart_tlr) as j: parameters_cart_tlr = json.loads(j.read())
...
with open(parameters_file_mountaincar_tlr) as j: parameters_mountaincar_tlr = json.loads(j.read())
